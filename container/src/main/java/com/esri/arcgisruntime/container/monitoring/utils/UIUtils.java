...
public class UIUtils {
    ...
    public static Context getContext() {
        return CMApplication.getAppContext();
    }

    public static Thread getMainThread() {
        return CMApplication.getMainThread();
    }

    public static long getMainThreadId() {
        return CMApplication.getMainThreadId();
    }
    ...
    public static Handler getHandler() {
        // 获得主线程的looper
        Looper mainLooper = CMApplication.getMainThreadLooper();
        // 获取主线程的handler
